...
<head>
    <meta charset="UTF-8">
    <title>QuickDoc - Medical Signup</title>
    <style>
        body {
    ...
    <div class="form-container">
        ...
        <form action="register" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="experienceYears" placeholder="e.g., 8.5" required>
            </div>
            ...
            <input type="submit" value="REGISTER DOCTOR" class="submit-btn">
